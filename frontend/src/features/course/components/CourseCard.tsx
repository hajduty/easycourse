...
export const CourseCard: FC<CourseResponse> = ({ courseName, courseDescription, createdBy }) => {
  return (
    <Card className="w-64 h-64 rounded-lg overflow-hidden shadow-md relative group cursor-pointer p-0 m-0">
      ...
      <div className="absolute bottom-0 w-full bg-stone-900 pt-2 transition-all duration-300 max-h-[18%] group-hover:max-h-full overflow-hidden px-4 pb-4">
